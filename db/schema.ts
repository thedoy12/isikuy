...
export const products = pgTable("products", {
  ...
  supplierProvider: varchar("supplierProvider", { length: 50 }).default("flowix").notNull(),
  supplierProductCode: varchar("supplierProductCode", { length: 100 }),
  supplierProductName: varchar("supplierProductName", { length: 255 }),
  supplierTargetFormat: varchar("supplierTargetFormat", { length: 50 }).default("auto").notNull(),
